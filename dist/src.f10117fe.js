...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/views/CollectionComponent.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function CollectionComponent(parent, collection) {
    this.parent = parent;
...
},{}],"src/views/Component.ts":[function(require,module,exports) {
"use strict"; // This is a general File
...
/** @class */
function () {
  function Component(parent, model) {
    this.parent = parent;
    this.model = model;
    this.regions = {};
    this.bindModel();
  ...
  Component.prototype.regionsMap = function () {
    return {};
  };

  Component.prototype.eventsMap = function () {
    return {};
  };

  Component.prototype.bindModel = function () {
    var _this = this;
  ...
  Component.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      ...
      var _a = eventKey.split(':'),
          eventName = _a[0],
          selector = _a[1]; // we add a new event listener to the particular html element
  ...
  Component.prototype.mapRegions = function (fragment) {
  ...
  Component.prototype.render = function () {
    ...
    var templateElement = document.createElement('template');
    templateElement.innerHTML = this.template(); // This is used to enable event handlers in our html

    this.bindEvents(templateElement.content); // This is used to nest it to parent components

    this.mapRegions(templateElement.content);
    this.onRender(); // this adds the snippet of html in the dom
...
},{"./Component":"src/views/Component.ts"}],"src/views/UserList.ts":[function(require,module,exports) {
"use strict";
...
var CollectionComponent_1 = require("./CollectionComponent");
...
function (_super) {
  ...
  return UserList;
}(CollectionComponent_1.CollectionComponent);

exports.UserList = UserList;
},{"./CollectionComponent":"src/views/CollectionComponent.ts","./UserShow":"src/views/UserShow.ts"}],"src/models/Model.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Eventing() {
    ...
    this.trigger = function (eventName) {
      ...
      var n = _this.events[eventName].length;

      for (var i = 0; i < n; ++i) {
        _this.events[eventName][i]();
      }
    };
  }
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/User":"src/models/User.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
